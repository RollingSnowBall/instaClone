...
final class ProfileViewController: UIViewController {
    ...
    private let followerDataView = ProfileDataView(title: "게시물", count: 2300)
    
    private let followingDataView = ProfileDataView(title: "게시물", count: 12)
...
private extension ProfileViewController {
    ...
    @objc func didTapRightBarButtonItem(){
        ...
        [
            UIAlertAction(title: "회원 정보 배경", style: .default),
